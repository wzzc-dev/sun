...
- `Canvas` line/polyline/polygon/rect/circle/ellipse and uniform/per-corner rounded-rect helpers for reusable GUI dividers, borders, badges, ovals, panels, tabs, buttons, charts, simple icons, and input backgrounds
