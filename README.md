...
- `RenderFrame` as a frame-sized canvas and layer-tree submit unit with resize lifecycle, dirty queries/marking, dirty-submit planning/results, result-level scheduler, did-present, and present-cost queries, and dirty/full present helpers for future event-loop integration
