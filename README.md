...
- `RenderFrame -> NativeSurface` dirty/full present helpers plus dry-run packed present batches and adapters for graphics-core strategy-aware submit/query/plan results with state, planned rect/cost, and full-present savings telemetry for window integration
