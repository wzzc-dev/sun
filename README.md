...
- `RenderFrame -> NativeSurface` dirty/full present helpers plus strategy-aware submit/query/plan results with state and cost telemetry for window integration
