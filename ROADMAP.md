...
- [x] 暴露 `Canvas::draw_mask_rect`、`Renderer::draw_glyph_atlas_entry` 与 `Renderer::draw_text_face_atlas`，让 glyph atlas entry 和带 cache/atlas telemetry 的基础 atlas-backed text path 可直接合成到 Pixmap
